...
```{r}
# Assigning new date format to datatime column of data frame
USGS.flow.data$datetime <- format(USGS.flow.data$datetime, "%y%m%d")

# Building a function to create early 1990s dates
create.early.dates <- (function(d) {
       paste0(ifelse(d > 181231,"19","20"),d)
       })
# Assigning new early dates to values in datetime column
