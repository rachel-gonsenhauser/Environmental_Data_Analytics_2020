...
\begin{longtable}[]{@{}ll@{}}
\toprule
\textbf{Dataset name} & \textbf{Dataset information}\tabularnewline
\midrule
\endhead
EPAAir\_O3\_NC2018\_raw.csv & Information about ozone\tabularnewline
NEON\_NIWO\_Litter\_trapdata\_raw.csv & Information about
litter\tabularnewline
\bottomrule
\end{longtable}
...
\tightlist
\item
  Kateri prefers to use the cable function to make tables, this is
  sometimes glitchy
\end{itemize}
