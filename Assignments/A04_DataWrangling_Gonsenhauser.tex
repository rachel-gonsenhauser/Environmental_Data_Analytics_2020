...
\NormalTok{EPA.air.O3}\FloatTok{.2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPA.air.O3}\FloatTok{.2019}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2019_raw.csv"}\NormalTok{)}
\NormalTok{EPA.air.PM25}\FloatTok{.2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPA.air.PM25}\FloatTok{.2019}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2019_raw.csv"}\NormalTok{)}

\CommentTok{#2}
\KeywordTok{dim}\NormalTok{(EPA.air.O3}\FloatTok{.2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPA.air.O3}\FloatTok{.2019}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPA.air.PM25}\FloatTok{.2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#3}
\KeywordTok{class}\NormalTok{(EPA.air.O3}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPA.air.O3}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPA.air.PM25}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{class}\NormalTok{(EPA.air.PM25}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPA.air.O3}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA.air.O3}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}
\NormalTok{EPA.air.O3}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA.air.O3}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}
\NormalTok{EPA.air.PM25}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA.air.PM25}\FloatTok{.2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}
\NormalTok{EPA.air.PM25}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPA.air.PM25}\FloatTok{.2019}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\CommentTok{#4}
\NormalTok{EPA.air.O3.}\FloatTok{2018.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.O3}\FloatTok{.2018}\NormalTok{, }
\NormalTok{                                 Date, DAILY_AQI_VALUE, Site.Name, }
\NormalTok{                                 AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
\NormalTok{EPA.air.O3.}\FloatTok{2019.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.O3}\FloatTok{.2019}\NormalTok{, }
\NormalTok{                                 Date, DAILY_AQI_VALUE, Site.Name, }
\NormalTok{                                 AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
\NormalTok{EPA.air.PM25.}\FloatTok{2018.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.PM25}\FloatTok{.2018}\NormalTok{, }
\NormalTok{                                   Date, DAILY_AQI_VALUE, Site.Name, }
\NormalTok{                                   AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
\NormalTok{EPA.air.PM25.}\FloatTok{2019.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.PM25}\FloatTok{.2019}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\CommentTok{#5}
\NormalTok{EPA.air.PM25.}\FloatTok{2018.}\NormalTok{subset}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{"PM2.5"}
\NormalTok{EPA.air.PM25.}\FloatTok{2019.}\NormalTok{subset}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ "PM2.5"}
...
\begin{Highlighting}[]
\CommentTok{#7}
\NormalTok{Ozone}\FloatTok{.2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Processed/EPAair_O3_NC2018_processed.csv"}\NormalTok{)}
\NormalTok{Ozone}\FloatTok{.2019}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Processed/EPAair_O3_NC2019_processed.csv"}\NormalTok{)}
\NormalTok{PM25}\FloatTok{.2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Processed/EPAair_PM25_NC2018_processed.csv"}\NormalTok{)}
\NormalTok{PM25}\FloatTok{.2019}\NormalTok{ <-}\StringTok{  }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Processed/EPAair_PM25_NC2019_processed.csv"}\NormalTok{)}

\NormalTok{EPA.AirPollutants <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(Ozone}\FloatTok{.2018}\NormalTok{, Ozone}\FloatTok{.2019}\NormalTok{, PM25}\FloatTok{.2018}\NormalTok{, PM25}\FloatTok{.2019}\NormalTok{)}

\CommentTok{#8}
\NormalTok{EPA.AirPollutants.wrangled <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(EPA.AirPollutants, Site.Name }\OperatorTok{%in%}\StringTok{ }
\StringTok{                                       }\KeywordTok{c}\NormalTok{(}\StringTok{"Linville Falls"}\NormalTok{, }\StringTok{"Durham Armory"}\NormalTok{, }
                                         ...
                                         \StringTok{"Bryson City"}\NormalTok{, }\StringTok{"Millbrook School"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Date, Site.Name, AQS_PARAMETER_DESC, COUNTY) }\OperatorTok{%>%}
\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{meanAQI =} \KeywordTok{mean}\NormalTok{(DAILY_AQI_VALUE),}
                         \DataTypeTok{meanLatitude =} \KeywordTok{mean}\NormalTok{(SITE_LATITUDE),}
                         \DataTypeTok{meanLongitude =} \KeywordTok{mean}\NormalTok{(SITE_LONGITUDE)) }\OperatorTok{%>%}
...
\CommentTok{#9}
\NormalTok{EPA.AirPollutants.spread <-}\StringTok{ }\KeywordTok{spread}\NormalTok{(EPA.AirPollutants.wrangled, }
\NormalTok{                                   AQS_PARAMETER_DESC, meanAQI)}

\CommentTok{#10}
\KeywordTok{dim}\NormalTok{(EPA.AirPollutants.spread)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#11}
\KeywordTok{write.csv}\NormalTok{(EPA.AirPollutants.spread, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#12a and 12b}
\NormalTok{EPA.AirPollutants.summary <-}\StringTok{ }\NormalTok{EPA.AirPollutants.spread }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Site.Name, Month, Year) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{meanOzone =} \KeywordTok{mean}\NormalTok{(Ozone),}
            \DataTypeTok{meanPM2.5 =} \KeywordTok{mean}\NormalTok{(PM2}\FloatTok{.5}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{drop_na}\NormalTok{(Month, Year)}


\CommentTok{#13}
\KeywordTok{dim}\NormalTok{(EPA.AirPollutants.summary)}
\end{Highlighting}
\end{Shaded}
...
dataset that have an NA in any column, which can get rid of a huge chunk
of the dataset.
\end{quote}
