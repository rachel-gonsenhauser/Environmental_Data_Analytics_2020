...
```{r}
#5 
# How to code bartlett test here?
...
# try running pairwise, figure out code



# Total nitrogen differs significantly across the two lakes but does not differ significantly seasonally and there is not a sigificant interaction effect between lake and month on total nitrogen (ANOVA, F1,4,4: 36.41, p<0.0001).
