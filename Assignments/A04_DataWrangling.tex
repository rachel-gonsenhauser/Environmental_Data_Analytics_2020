...
\CommentTok{#4}
\NormalTok{EPA.air.O3.}\FloatTok{2018.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.O3}\FloatTok{.2018}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
\NormalTok{EPA.air.O3.}\FloatTok{2019.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.O3}\FloatTok{.2019}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
\NormalTok{EPA.air.PM25.}\FloatTok{2018.}\NormalTok{subset <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPA.air.PM25}\FloatTok{.2018}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}
...
\CommentTok{#9}
\NormalTok{EPA.AirPollutants.spread <-}\StringTok{ }\KeywordTok{spread}\NormalTok{(EPA.AirPollutants.wrangled, AQS_PARAMETER_DESC, meanAQI)}
