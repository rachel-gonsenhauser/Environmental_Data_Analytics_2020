...
# 5
Days <-
  as.data.frame(GaringerOzone.wrangled$Date, seq(2010-01-01:2019-12-31))
colnames(Days) <- c("Date")

# Getting warning message, did I do this correctly?**

# 6
GaringerOzone <- left_join(Days,
                           GaringerOzone.wrangled)

# How to do this? Coming up short on observations, probably because some omitted in above step**
...
> Answer: In this case, using a piecewise constant would be inappropriate because this would assume that missing data are equal to the measurement made nearest to that date, and this is not necessarily a correct assumption for ozone concentrations. Additionally, spline interpolation is inappropriate because this uses a quadratic function to interpolate, and we have no reason to expect that the data fits to a quadratic equation from the plot of data examined above. 

>Check during office hours, is this a correct explanation?***
...
> Answer: The seasonal Mann-Kendall is the most appropriate time series analysis to run in this case because it assumes seasonality,...

> Finish later, check during office hours***
...
# Am I running this on the correct object?**
...
> Answer: There is a significant seasonal trend in ozone concentration data at Garinger High School over the period of 2010-2019 (seasonal Mann-Kendall: z=-2.2478, p=0.02459). The slope of this trend indicates that ozone concentrations are slightly decreasing over time at Garinger High School (Sen's Slope=-0.000207152). We did not detect any trends across individual months in the dataset.

>Ask in office hours: is this interpretation correct?***
