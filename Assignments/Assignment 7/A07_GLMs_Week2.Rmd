...
# Check with Njeri, should we be including lakename here?***
```
...
> Answer: Year, day number, and depth all significantly predict temperature (multiple linear regression: F=9303, df=3,9718, p<0.0001). This model explains 74.2% of the observed variance in temperature (R2=0.7417).
...
> Answer: The mixed effects model is the better model because it has a lower AIC value. This means that the mixed effects model is more parsimonious while also accounting for a good amount of variation in the response variable.

>Check interpretation here with Njeri***