...
library(cowplot)
plot_grid((TempPlot + theme(legend.position = "none")), (TPPlot + theme(legend.position = "none")), (TNPlot + theme(legend.position = "right")), nrow = 1, align = 'h')
print
...
> Answer: ***come back to this, how do you look across seasons with a boxplot?
