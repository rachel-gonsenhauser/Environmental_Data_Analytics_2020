...
> Answer: We used drop_na because this allows us to only drop observations where there are NAs in specific columns (in this case, month or year). Conversely, na.omit would omit all observations from the data set that have an NA in any column, which can get rid of a hug chunk of the dataset.
