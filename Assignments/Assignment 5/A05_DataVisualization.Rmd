...
library(cowplot)
plot_grid((TempPlot + theme(legend.position = "none")), (TPPlot + theme(legend.position = "none")), (TNPlot + theme(legend.position = "bottom")), nrow = 3, rel_heights = c(1, 1, 1.5), align = 'hv')
print
```
